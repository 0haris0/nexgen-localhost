    ...
    > & {
      lineItems: Array<
        Pick<AdminTypes.AppSubscriptionLineItem, "id"> & {
          plan: {
            pricingDetails:
              | ({ __typename: "AppRecurringPricing" } & Pick<
...
export type GetResponseShopQueryVariables = AdminTypes.Exact<{
  [key: string]: never;
}>;

export type GetResponseShopQuery = {
  shop: Pick<
    AdminTypes.Shop,
    | "id"
    | "name"
    ...
    | "description"
  > & {
    primaryDomain: Pick<AdminTypes.Domain, "id" | "host" | "url">;
    plan: Pick<AdminTypes.ShopPlan, "displayName">;
    billingAddress: Pick<
      AdminTypes.ShopAddress,
      "address1" | "city" | "country" | "phone" | "zip" | "formatted"
    >;
  };
...
export type GetProductsQuery = {
  shop: Pick<AdminTypes.Shop, "id" | "name">;
  products: {
    edges: Array<{
      node: Pick<
        AdminTypes.Product,
        ...
        | "createdAt"
      > & {
        category?: AdminTypes.Maybe<
          Pick<AdminTypes.TaxonomyCategory, "id" | "fullName" | "name">
        >;
...
export type GetShopDataQueryVariables = AdminTypes.Exact<{
  [key: string]: never;
}>;
...
export type GetShopDataQuery = {
  shop: Pick<
    AdminTypes.Shop,
    "id" | "name" | "url" | "unitSystem" | "currencyCode" | "description"
  > & {
    primaryDomain: Pick<AdminTypes.Domain, "id" | "host" | "url">;
    plan: Pick<AdminTypes.ShopPlan, "displayName">;
  };
...
interface GeneratedQueryTypes {
  ...
  "\n    #graphql\n    query getResponseShop{\n      shop{\n        id\n        name\n        primaryDomain {\n          id\n          host\n          url\n        }\n        myshopifyDomain\n        url\n        unitSystem\n        currencyCode\n        contactEmail\n        name\n        description\n        plan{\n          displayName\n        }\n        billingAddress{address1,city,country,phone, zip,formatted}\n      }\n      productsCount{\n        count\n      }\n      currentAppInstallation {\n        activeSubscriptions {\n          id\n          name\n          test\n          status\n          createdAt\n          trialDays\n          currentPeriodEnd\n        }\n      }\n\n    }\n  ": {
    return: GetResponseShopQuery;
    variables: GetResponseShopQueryVariables;
  };
  ...
  "\n    #graphql\n    query getShopData {\n      shop {\n        id\n        name\n        primaryDomain { id host url }\n        url\n        unitSystem\n        currencyCode\n        description\n        plan { displayName }\n      }\n      currentAppInstallation {\n        activeSubscriptions {\n          id\n          name\n          test\n          status\n          createdAt\n          trialDays\n          currentPeriodEnd\n        }\n      }\n      productsCount { count }\n    }": {
    return: GetShopDataQuery;
    variables: GetShopDataQueryVariables;
  };
}
