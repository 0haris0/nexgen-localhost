...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  let res, planData, subscriptionData, dataPayment;
  ...
  let shopIdVal = responseShopJson.data?.shop;
            ...
            <Card sectioned>
              ...
              >
                <IndexTable.Row id={"heading"}>
                  ...
                  <IndexTable.Cell as={"th"}>Amount</IndexTable.Cell>
                </IndexTable.Row>
                <IndexTable.Row>
                  ...
                  <IndexTable.Cell>
                    ...
                    <Text variant={"bodyXs"}>
                      <i>
                        (Title, Description, Category, Tags, SEO Title and
                        Description)
                      </i>
                    </Text>
                  </IndexTable.Cell>
